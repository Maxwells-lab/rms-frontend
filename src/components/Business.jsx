  ...
  return (
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
        ...
        <TableCell align="right">{row.Date_of_Issuance}</TableCell>
    ...
    <TableContainer component={Paper}>
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            <TableCell />
            <TableCell>Ownwer_name</TableCell>
            <TableCell align="right">Building_ID</TableCell>
            <TableCell align="right">Payment_Status</TableCell>
            <TableCell align="right">Date_of_Issuance</TableCell>
