...
class mapp extends Component {
  ...
  componentDidUpdate(prevState) {
    ...
    if (
      ...
      this.state.rotate !== prevState.rotate ||
      this.state.translate !== prevState.translate ||
      this.state.styles !== prevState.styles
    ) {
      var interaction = new Transform({
        enableRotatedTransform: false,
        /* Limit interaction inside bbox * /
          ...
          <ul>
            ...
            <li>
              <input
                ...
                onChange={this.setPropertieScale}
              />
              <label> enable scale</label>
            </li>
            <li>
              <input
                className="stretch"
                ...
                onChange={this.setPropertieStretch}
                disabled={this.state.disableStretch}
              />
